...
export default async function handler(req, res) {
  ...
  try {
    ...
    const scoringPrompt = `
You are a TOEFL Email Writing evaluator.
...
4. Focus on:
   ...
   - naturalness
5. If the email does not respond to all required points, lower the score.
6. If the tone is too casual or rude, lower the score.
7. If the response is too short, vague, or incomplete, lower the score.
